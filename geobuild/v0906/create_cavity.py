...
def crRFHoles1(geo, fd):
    ...
    exclg3 = " -( -wgzdn +wgxdn )"
    exclg3w = " -( -wgzwdn +wgxwdn ) -( +wgzwup +wgxdn ) "
    
    exclg3zb = " -( -wgxdn +wgxup +wgzwup -wgzup )"
    exclg3zb = " "
    exclg3z= " -( wgxsdp -wgxsdm +wgzdn -wgzwdn -wgxup ) "

    body = ["* dummy entry" ]

    #region = [ "WaveG3   6 +z3inpln0 -wgzdn  %s %s " % (region_wg,exclg3), 
    #           "WaveGW3  6 +z3inpln0 -wgzwdn  %s -( %s -wgzdn ) %s " % (region_wgw, region_wg, exclg3w ),
    #           "WaveZG3    6 %s +wgxdn -yzplane -r1cav6 -r1cav7 -r1cav8 -r1cvb " % region_zwg,
    #           "WaveZGW3  6  %s -( %s ) +wgxdn -yzplane -r1cav6 -r1cav7 -r1cav8 -r1cvb %s %s" % (region_zwgw, region_zwg, exclg3z, exclg3zb ),
    #           "CBsol3   6 +z3inpln0 -cbsolzmx +cbsol ",
    #           "CBsol3z  6 +cbsolz -cbsol +cbsolxc -r1Bsolo -yzplane ",
    #           "CBgsol3z  6 +cbgsolz +rbound1 -cbsolz -r1Bsolo -yzplane ",
    #           "WLsol3   6 +z3inpln0 -wlsolzmx +wlsol ",
