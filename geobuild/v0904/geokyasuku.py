...
#                 "shield_rin": 120.0 } # Inner radius of inner concrete shield
    ...
    #    "rmax":1100.0,  # rmax of whole area
        ...
        "FeSh_thick": 40.0, # Thickness of Iron sheild inside of concrete sheild
    ...
    #@ parameters for Cask study
    geo["Cask"] = { "thick":5.0, # "Cask Thickness", 
                    "bh_size": 1.0, # "Blackhall thickness",
                    "air_thick":100.0 } # "Thickness of air region outside cask"

    geo["Cask"]["bh_rmin"] = glp["CShIn_rmin"] - glp["FeSh_thick"]
    geo["Cask"]["bh_rmax"] = geo["Cask"]["bh_rmin"] + geo["Cask"]["bh_size"]
    geo["Cask"]["rmax"] = geo["Cask"]["bh_rmax"] + geo["Cask"]["thick"]
    geo["Cask"]["air_rmax"] = geo["Cask"]["rmax"] + geo["Cask"]["air_thick"]

    # geo["Cask"]["bh_zup"] = geo["front"]["CSh_up_pos"] - geo["global"]["CSh_up_thick"] - geo["Cask"]["bh_size"]
    geo["Cask"]["bh_zup"] = geo["front"]["CSh_up_pos"] + geo["global"]["FeSh_thick_upstream"] - geo["Cask"]["bh_size"]
    geo["Cask"]["zup"] = geo["Cask"]["bh_zup"] - geo["Cask"]["thick"]
    geo["Cask"]["air_zup"] = geo["Cask"]["zup"] - geo["Cask"]["air_thick"]

    geo["Cask"]["bh_zdn"] = zbound3 + geo["G4Param"]["Kasokukan_one_unit_cho"] + geo["bases"]["Collimator_thickness"]
    geo["Cask"]["bh_zdn"] = zbound3
    geo["Cask"]["zdn"] = geo["Cask"]["bh_zdn"] + geo["Cask"]["bh_size"]
    geo["Cask"]["air_zdn"] = geo["Cask"]["zdn"] + geo["Cask"]["thick"]
    geo["bases"]["zmax"] = geo["Cask"]["air_zdn"] + geo["Cask"]["air_thick"]
    geo["bases"]["zmin"] = geo["Cask"]["air_zup"]
    glp["zmin"] = geo["bases"]["zmin"]
